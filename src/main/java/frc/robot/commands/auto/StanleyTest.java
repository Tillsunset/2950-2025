...
public class StanleyTest extends Command {
    ...
    private double steerKp = 1; // tune heading error
	private double k = 0.5; // tune correct cross error
	...
	private static int numInterpolationPoints = 4;

	Pose current = new Pose(0, 0, 0);
    Pose goal = new Pose(2, 2, Math.PI / 2);
	...
	public void initialize() {
		...
		waypoints = interpolateAlignedPoints(current, goal, numInterpolationPoints);
	}
