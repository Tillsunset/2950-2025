...
public class leaveScoreCoralL2 extends Command {
	...
	public leaveScoreCoralL2(driveTrain driveTrain, elevator elevator, coralIntake coralIntake) {
	...
	public void execute() {
		if (m_timer.get() < 4) {
			...
			m_elevator.updateTargetPosition(15.5);
		}
